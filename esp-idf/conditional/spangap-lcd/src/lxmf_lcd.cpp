...
/* The propagation-node list, read-only. The settings collection owns editing it
 * (lxmf.cpp, the lxmf.pnode.* sentinels); what the app still needs is the names,
 * for the "send via node" picker on the compose screen. */
